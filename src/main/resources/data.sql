...
INSERT INTO product (product_type_id, description, price, user_id , model,brand ) VALUES
        (1, 'Aparat Horyzont horizont panoramiczny', 650.00,4, 'Model123', 'BrandXYZ'),
        (1, 'Auto Flash aparat fotograficzny', 150.55,4, 'Instax mini','Instax'),
        (1,'Praktycznie jak nowy aparat analogowy ELIKON 35mm wraz oryginalnym futerale w ładnym stanie',120.45,5, 'ELIKON 35mm','ELIKON '),
        (1, 'Aparat cyfrowy marki XYZ', 258.78,5,'ZSE158','Canon'),
        (1, 'Lustrzanka analogowa w dobrym stanie', 147.45,5,'WWER34','Nikon'),
        (1, 'Kompaktowy aparat do fotografii podróżniczej', 159.12,6,'3TRE','Polaroid'),
        (1, 'Klasyczny aparat analogowy', 236.56,6,'45FGHN','Polaroid'),
        (1, 'Antyczny aparat z lat 60.', 74.45,6,'ASDW3','Canon'),
        (1, 'Kieszonkowy aparat na klisze', 45.45,6,'WER4','Nikon'),
        (1, 'Nowoczesny aparat cyfrowy z wieloma funkcjami', 199.99,7,'EHU78','Nikon'),
        (1, 'Profesjonalny aparat do fotografii studyjnej', 159.78,8,'7U7','Polaroid'),
        (1, 'Retro aparat z klapką', 145.55,9,'JHT5','Polaroid'),
        (1, 'Klasyczny aparat analogowy', 147.45,9,'AQW34','Canon'),
        (1, 'Aparat do fotografii krajobrazowej', 45.78,10,'FGHY56','Nikon'),
        (1, 'Lustrzanka cyfrowa dla zaawansowanych', 147.74,10,'FG4','Polaroid'),
        (1, 'Aparat do fotografii ulicznej', 45.45,10,'TY6','Canon'),
        (2,'Klisza bez żadnych nagrań.',12.15,4,'Model123', 'BrandXYZ'),
        (2,'Klisza z ujęciami pięknych widoków na morze i plażę',5.18,10,'Instax mini','Instax'),
        (2,'Klisza bez żadnych nagrań',47.45,1,'3TRE','Polaroid'),
        (2,'Klisza bez żadnych nagrań',12.25,1,'TY6','Canon'),
        (2,'Klisza bez żadnych nagrań',14.15,1,'FG4','Polaroid'),
        (2,'Klisza bez żadnych nagrań',12.15,1,'FGHY56','Nikon'),
        (2,'Klisza bez żadnych nagrań',5.6,1,'7U7','Polaroid'),
        (2,'Klisza bez żadnych nagrań',14.15,1,'WER4','Nikon'),
        (2,'Klisza z zapisem koncertu ulubionego zespołu',10.99,7,'WWER34','Nikon'),
        (2,'Klisza z ujęciami z egzotycznych podróży i miejsc.',11.11,5,'ZSE158','Canon'),
        (2,'Klisza z zapisem emocjonujących wydarzeń sportowych.',14.17,6,'WWER34','Nikon'),
        (2,'Klisza z zapisem emocjonujących wydarzeń sportowych.',13.15,8,'ZSE158','Canon'),
        (2,'Klisza zawierająca eksperymentalne ujęcia artystyczne',50.6,10,'ZSE158','Canon'),
        (2,'Klisza z ujęciami związanych z nowoczesną technologią.',12.99,5,'ZSE158','Canon'),
        (3, 'Obiektyw Model A', 150.00,4,'AQSQ','QWE'),
        (3, 'Obiektyw Model B', 200.00,5,'QRRW','QWRQWR'),
        (3, 'Zoom Lens XYZ', 300.00,10,'QRWR','QWRQWR'),
        (3, 'Obiektyw stałoogniskowy 50mm', 120.00,4,'QRWR','QRWQR'),
        (3, 'Obiektyw szerokokątny', 250.00,1,'QRW','QRWR'),
        (4, 'Drewniany podstawek', 20.00,8,'\DG','Gsd'),
        (4, 'Metalowy podstawek', 15.00,9,'sggs','gfb'),
        (4, 'Dekoracyjny podstawek', 25.00,4,'rea','RGG'),
        (4, 'Podstawek odporny na ciepło', 18.00,5,'RGHRG','RGRG'),
        (4, 'Silikonowy podstawek', 12.00,7,'BDRB','GWSGR'),
        (5, 'Skórzane etui na aparat', 40.00,7,'GWRG','GWG'),
         (5, 'Etui o twardej powłoce', 35.00,9,'GWSGW','GWEGWE'),
        (5, 'Miękkie, wyściełane etui', 30.00,9,'EGWEG','GWEGE'),
        (5, 'Wodoodporne etui', 45.00,3,'GEWG','WGEWG'),
        (5, 'Kompaktowe etui na aparat', 25.00,5,'GEWG','GEWG'),
        (6, 'Zewnętrzna lampa błyskowa Model X', 80.00,6,'GWEG','WET'),
        (6, 'Zestaw lamp błyskowych bezprzewodowych', 120.00,7,'RHGWR','WGWGW'),
        (6, 'Lampa błyskowa LED do aparatu', 65.00,4,'WEGE','FBSFB'),
        (6, 'Kompaktowa jednostka błyskowa', 50.00,5,'EGWEGE','GEGE'),
        (6, 'Lampa studyjna', 150.00,6,'EGEWGEW','EWGWEGEW');
-- insert Camera
