...
INSERT INTO product_type (name_type_product) VALUES
    ...
    ('Flash');
-- insert Product
INSERT INTO product (product_type_id, description, price, user_id) VALUES
                                                                       (1, 'Aparat Horyzont horizont panoramiczny', 650.00,4),
                                                                       (1, 'Auto Flash aparat fotograficzny', 150.55,4),
                                                                       (1,'Praktycznie jak nowy aparat analogowy ELIKON 35mm wraz oryginalnym futerale w ładnym stanie',120.45,5),
                                                                       (1, 'Aparat cyfrowy marki XYZ', 258.78,5),
                                                                       (1, 'Lustrzanka analogowa w dobrym stanie', 147.45,5),
                                                                       (1, 'Kompaktowy aparat do fotografii podróżniczej', 159.12,6),
                                                                       (1, 'Klasyczny aparat analogowy', 236.56,6),
                                                                       (1, 'Antyczny aparat z lat 60.', 74.45,6),
                                                                       (1, 'Kieszonkowy aparat na klisze', 45.45,6),
                                                                       (1, 'Nowoczesny aparat cyfrowy z wieloma funkcjami', 199.99,7),
                                                                       (1, 'Profesjonalny aparat do fotografii studyjnej', 159.78,8),
                                                                       (1, 'Retro aparat z klapką', 145.55,9),
                                                                       (1, 'Klasyczny aparat analogowy', 147.45,9),
                                                                       (1, 'Aparat do fotografii krajobrazowej', 45.78,10),
                                                                       (1, 'Lustrzanka cyfrowa dla zaawansowanych', 147.74,10),
                                                                       (1, 'Aparat do fotografii ulicznej', 45.45,10),
                                                                       (2,'Klisza bez żadnych nagrań.',12.15,4),
                                                                       (2,'Klisza z ujęciami pięknych widoków na morze i plażę',5.18,10),
                                                                       (2,'Klisza bez żadnych nagrań',47.45,1),
                                                                       (2,'Klisza bez żadnych nagrań',12.25,1),
                                                                       (2,'Klisza bez żadnych nagrań',14.15,1),
                                                                       (2,'Klisza bez żadnych nagrań',12.15,1),
                                                                       (2,'Klisza bez żadnych nagrań',5.6,1),
                                                                       (2,'Klisza bez żadnych nagrań',14.15,1),
                                                                       (2,'Klisza z zapisem koncertu ulubionego zespołu',10.99,7),
                                                                       (2,'Klisza z ujęciami z egzotycznych podróży i miejsc.',11.11,5),
                                                                       (2,'Klisza z zapisem emocjonujących wydarzeń sportowych.',14.17,6),
                                                                       (2,'Klisza z zapisem emocjonujących wydarzeń sportowych.',13.15,8),
                                                                       (2,'Klisza zawierająca eksperymentalne ujęcia artystyczne',50.6,10),
                                                                       (2,'Klisza z ujęciami związanych z nowoczesną technologią.',12.99,5),
                                                                       (3, 'Obiektyw Model A', 150.00,4),
                                                                       (3, 'Obiektyw Model B', 200.00,5),
                                                                       (3, 'Zoom Lens XYZ', 300.00,10),
                                                                       (3, 'Obiektyw stałoogniskowy 50mm', 120.00,4),
                                                                       (3, 'Obiektyw szerokokątny', 250.00,1),
                                                                       (4, 'Drewniany podstawek', 20.00,8),
                                                                       (4, 'Metalowy podstawek', 15.00,9),
                                                                       (4, 'Dekoracyjny podstawek', 25.00,4),
                                                                       (4, 'Podstawek odporny na ciepło', 18.00,5),
                                                                       (4, 'Silikonowy podstawek', 12.00,7),
                                                                       (5, 'Skórzane etui na aparat', 40.00,7),
                                                                       (5, 'Etui o twardej powłoce', 35.00,9),
                                                                       (5, 'Miękkie, wyściełane etui', 30.00,9),
                                                                       (5, 'Wodoodporne etui', 45.00,3),
                                                                       (5, 'Kompaktowe etui na aparat', 25.00,5),
                                                                       (6, 'Zewnętrzna lampa błyskowa Model X', 80.00,6),
                                                                       (6, 'Zestaw lamp błyskowych bezprzewodowych', 120.00,7),
                                                                       (6, 'Lampa błyskowa LED do aparatu', 65.00,4),
                                                                       (6, 'Kompaktowa jednostka błyskowa', 50.00,5),
                                                                       (6, 'Lampa studyjna', 150.00,6);
-- insert Camera
...
INSERT INTO film (id_camera, loaded_frames, is_full, id_produktu, is_for_sale, user_id,max_loaded) VALUE
    ...
    (null,0,false,19,true, 1,50),
    (null,0,false,20,true,1,50),
    (null,0,false,21,true,1,50),
    (null,0,false,22,true,1,50),
    (null,0,false,23,true,1,50),
    (null,0,false,24,true,1,50),
